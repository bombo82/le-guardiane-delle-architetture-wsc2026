// Anti-Corruption Layer: traduce la Published Language di `payment` nei command interni di `booking`.
// Isola `booking` dalle evoluzioni del modello interno di `payment`: l'unico contratto condiviso è `PaymentResultIntegrationEvent`.
