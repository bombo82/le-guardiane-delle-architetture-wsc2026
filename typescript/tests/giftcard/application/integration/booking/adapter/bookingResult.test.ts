...
describe('BookingResult', () => {
  ...
  it('adapts BookingCompleted to CreditGiftCard', () => {
    ...
    const result = bookingResult.adaptCredit(event);
  ...
  it('adapts BookingRejected to RefundGiftCard', () => {
    ...
    const result = bookingResult.adaptRefund(event);
  ...
  it('throws on null credit event', () => {
    expect(() => bookingResult.adaptCredit(null as unknown as Parameters<typeof bookingResult.adaptCredit>[0])).toThrow();
  });

  it('throws on null refund event', () => {
    expect(() => bookingResult.adaptRefund(null as unknown as Parameters<typeof bookingResult.adaptRefund>[0])).toThrow();
  });
});
