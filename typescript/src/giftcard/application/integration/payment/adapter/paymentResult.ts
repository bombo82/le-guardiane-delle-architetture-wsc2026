// Anti-Corruption Layer: isola `giftcard` dalle evoluzioni del modello interno di `payment`;
// l'unico contratto condiviso è la Published Language `PaymentResultIntegrationEvent`.
