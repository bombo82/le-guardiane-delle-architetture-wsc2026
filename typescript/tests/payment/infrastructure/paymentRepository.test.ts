...
describe('PaymentRepository', () => {
  ...
  describe('save', () => {
    it('should persist new payment', () => {
      ...
      const original = Payment.request(paymentId, new ClientReference(clientReference), amount, requestedAt);
      ...
      expect(reloaded!.clientReference().value).toEqual(clientReference);
  ...
  describe('findByClientReference', () => {
    it('should return payment when client reference matches', () => {
      ...
      const found = repository.findByClientReference(new ClientReference(clientReference));
    ...
    it('should return empty when client reference does not match', () => {
      const found = repository.findByClientReference(new ClientReference('non-existing-reference'));
