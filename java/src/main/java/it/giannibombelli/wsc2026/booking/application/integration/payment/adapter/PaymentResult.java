...
/**
 * Anti-Corruption Layer che traduce la Published Language di {@code payment} nei command
 * interni di {@code booking}: l'unico contratto condiviso è {@link PaymentResultIntegrationEvent}.
 */
